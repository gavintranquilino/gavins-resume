...
\resumeSubheading
  ...
  \resumeItemListStart
    ...
    \resumeItem{Developed software interface to bridge high-level \textbf{ROS2} commands to low-level embedded systems over a \textbf{CAN bus}.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
          ...
          \textbf{Libraries/Frameworks}{: ROS2, Docker, OpenCV, YOLOv8, Git, MediaPipe, Flask, Selenium, NumPy, OpenGL} \\
