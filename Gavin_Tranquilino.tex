...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
          ...
          \textbf{Mechanical}{: SolidWorks, AutoCAD, GD\&T, CAD, 3D Printing, Machine Tools} \\
...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    % create points for relevant courses and awards
    \resumeItemListStart
      \resumeItem{\textbf{Coursework}: Data Structures, Algorithms, Linear Algebra, Circuits, Structure and Properties of Materials, OOP}
    \resumeItemListEnd
\resumeSubHeadingListEnd
