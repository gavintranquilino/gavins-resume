...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
          ...
          \textbf{Mechanical}{: SolidWorks, AutoCAD, Fusion360, GD\&T, CAD, 3D Printing, Machine Tools} \\
          \textbf{Electrical}{: KiCAD, I2C, SPI, UART, Arduino, ESP-IDF, Soldering, Oscilloscope} \\
          \textbf{Software}{: Python, C, C++, ROS2, Docker, CMake, OpenGL, OpenCV, Linux, Ubuntu, Git} \\
...
\resumeSubheading
{\href{https://uwaterloo.ca/engineering-ideas-clinic/}{\underline{Undergraduate Research Assistant}}}{September 2024 -- December 2024}
{University of Waterloo - Engineering IDEAs Clinic}{Waterloo, ON}
\resumeItemListStart
\resumeItem{Designed, instrumented, and analyzed a digital twin of a crutch in \textbf{SolidWorks}, optimizing material selection via FEA for realistic load scenarios.}
...
\resumeItem{Built and demonstrated wall-following robots using \textbf{Gazebo} and \textbf{TurtleBot3}, showcasing \textbf{LIDAR} integration and sensor interfacing in Python.}
\resumeItem{Implemented \textbf{PID} control algorithms in \textbf{C++} and \textbf{Python} packages, providing practical demos for 100+ attendees.}
\resumeItemListEnd
...
\resumeProjectHeading
{\textbf{\href{https://www.youtube.com/playlist?list=PL2zKq55_kXLcBZ80Y-t7BwzdXdnPQslFN}{\underline{Instrumented Knee Crutch}}} $|$ \emph{}}{}
\resumeItemListStart
