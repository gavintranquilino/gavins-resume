...
\resumeSubHeadingListStart
  \resumeSubheading
    ...
    \resumeItemListStart
      \resumeItem{\textbf{Coursework}: Data Structures, Algorithms, Linear Algebra, Circuits, OOP, Microprocessors, Digital Logic (FPGA, PLCs), Mechanics of Deformable Solids, Structure and Properties of Materials, Statistics, Ordinary Differential Equations}
    \resumeItemListEnd
