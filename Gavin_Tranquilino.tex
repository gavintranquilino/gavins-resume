...
\resumeItem{Built wall-following and swarm robots using \textbf{Gazebo} and \textbf{TurtleBot3}, showcasing \textbf{LIDAR} integration and sensor interfacing in Python.}
...
\begin{itemize}[leftmargin=0.15in, label={}]
    \small{\item{
          ...
          \textbf{Electrical}{: KiCAD, I2C, SPI, UART, Arduino, ESP-IDF, Soldering, Oscilloscope, LiDAR, PLC, VHDL, Verilog, FPGA} \\
          \textbf{Software}{: Python, C, C++, CMake, OpenGL, JavaScript, TypeScript, HTML, CSS, Bash, SQL, LaTeX, ROS2, Docker} \\
          \textbf{Libraries}{: OpenCV, Mediapipe, Linux, Ubuntu, Git, SSH, Django, Flask, NumPy, Matplotlib, Node.js} \\
          }}
\end{itemize}
